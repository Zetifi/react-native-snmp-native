...
function Session(options) {
    ...
    //});
    self.socket.bind() //currently react-native-udp doesn't support the exclusive functionality so we'll call a standard bind, shouldn't be big issue on mobile?
}
